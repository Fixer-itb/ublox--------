...
const prcopt_t default_opt = {
    /* defaults processing options */
    PMODE_SINGLE,
    0,
    1,
    SYS_GPS | SYS_CMP,                                                /* mode,soltype,nf,navsys */
    15.0 * D2R,                                                       /* elmin*/
    ...
    5,
    0,
    10, /* sateph,modear,glomodear,maxout,minlock,minfix */
    IONOOPT_BRDC,
    TROPOPT_SAAS,
    0,
    ...
    {0},
    {0},
    {10.780175707, 106.660899381, 31.5523} /* baseline,ru,rb */
    //    {"",""},                    /* anttype */
